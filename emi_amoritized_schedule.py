...
def calculate_loan_schedule(loan_amount, annual_interest_rate, loan_term_months, monthly_prepayment):
    ...
    start_amount = 10000  # Starting prepayment amount
    end_amount = monthly_prepayment + 1   # Ending prepayment amount (exclusive) so adding 1 extra
    step = 10000        # Increment step
    # Create an array of prepayment amounts
    prepayment_array = np.arange(start_amount, end_amount, step)

    for month in range(1, loan_term_months + 1):
        interest_payment = remaining_balance * monthly_interest_rate
        
        monthly_prepayment = random.choice(prepayment_array) # You may pay 10000 to 50000 each month
...
if __name__ == "__main__":
    # Example usage:
    loan_amount = 1000000  # Replace with your loan amount
    annual_interest_rate = 9.3  # Replace with your annual interest rate
    loan_term_years = 20  # Replace with your loan term in years
